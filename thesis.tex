...
%\usepackage{keyval} % enables parsing of keys for custom commands.
%\usepackage{ifthen} % so that I can use an if then statement
...
\includeonly{cross_coupling_luciferins}
...
% --- define a command for inserting a standard figure --- %
% \define@key{stdFigure}{width}{\stdf@width{#1}}
% \define@key{stdFigure}{label}{\def\stdf@label{#1}}
%
% \newcommand{\stdFigure}[4]{
% \setkeys{stdFigure}{width=1,label=\@empty}
% \setkeys{stdFigure}{#1}
% \begin{figure}[htbp]
% \includegraphics[width = \stdf@width\textwidth]{#2}
% \centering
% \caption[#3]{#4}
% \ifthenelse{\equal{\stdf@label}{}}{}{\label{\stdf@label}}
% \end{figure}
% }
